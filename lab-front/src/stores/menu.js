...
const MenuList = [{
  ...
  icon: 'team',
  items: [
    {id: '0201', title: '个人信息管理', icon: 'user', router: 'Test'}
  ]
}, {
  id: '04',
  title: '项目管理',
  ...
  icon: 'profile',
  items: [
    {id: '0501', title: '论文信息', icon: 'file-pdf', router: 'Test'},
    {id: '0502', title: '著作权信息', icon: 'copyright', router: 'Test2'},
  ...
  icon: 'notification',
  items: [
    {id: '0601', title: '活动信息管理', icon: 'setting', router: 'Test'}
  ]
}]
