                ...
                <Col span={10} offset={6}>
                  ...
                  <Form>
                    ...
                    <p style={{display: 'flex'}}>
                      ...
                      <Input type="text" name="username" className="username" placeholder="请输入用户名"
                             value={LoginIndexStore.getUserInfo.username} onChange={this.changeUsername.bind(this)}/>
                    </p>
                    <br/>
                    <p style={{display: 'flex'}}>
                      <span style={{width: '90px'}}>密码：</span>
                      <Input type="password" name="password" className="password" placeholder="请输入用户名"
                             value={LoginIndexStore.getUserInfo.passWd} onChange={this.changePassword.bind(this)} onPressEnter={this.login.bind(this)}/>
                    </p>
                    <br/>
                    <p style={{display: 'flex'}}>
                      <Button style={{marginLeft: '198px'}} type="primary" name="submit" onClick={this.login.bind(this)}
                              loading={CommonStore.getNodeSpin.login}>登陆</Button>
                    </p>
                  </Form>
                </Col>
              </Row>
